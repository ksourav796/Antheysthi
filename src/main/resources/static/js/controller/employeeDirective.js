    ...
    return {
        ...
        link: function ($scope, $timeout, $location, $filter) {
            ...
            $scope.getPaginatedEarningList = function (page) {
                ...
                $http.post($scope.hiposServerURL + "/getPaginatedEarningList?&type=" +  $scope.inactiveStatus+ '&searchText=' + $scope.searchText, angular.toJson(paginationDetails)).then(function (response) {
                    var data = response.data;
                    console.log(data);
                    var i = 0;
            ...
            $scope.getPaginatedDeductionList = function (page) {
                ...
                $http.post($scope.hiposServerURL + "/getPaginatedDeductionList?&type=" +  $scope.inactiveStatus+ '&searchText=' + $scope.searchText, angular.toJson(paginationDetails)).then(function (response) {
                    var data = response.data;
                    console.log(data);
                    var i = 0;

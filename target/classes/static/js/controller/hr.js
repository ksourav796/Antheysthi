app.controller('hrController',
    function ($scope, $timeout, $http, $location, $filter, Notification,$window,$rootScope) {
        ...
        $scope.getCountryList = function (val) {
            ...
            $http.post($scope.hiposServerURL  + '/getCountryList?searchText=' + val).then(function (response) {
        ...
        $scope.countryState = function (country) {
            $(".loader").css("display", "block");
            $http.post( $scope.hiposServerURL + '/getstateMaster?countryName=' + country).then(function (response) {
                var data = response.data;
        ...
        $scope.stateCity = function (state) {
            $(".loader").css("display", "block");
            $http.post( $scope.hiposServerURL + '/getcityMaster?StateId=' + state).then(function (response) {
                var data = response.data;
                // $scope.stateNameText=data.stateName;
                $scope.cityList = data;
        ...
        $scope.getHrList = function (val) {
            ...
            $(".loader").css("display", "block");
            $http.post($scope.hiposServerURL  + '/getHrApplicList?searchText=' + val).then(function (response) {
                var data = response.data;
                $scope.hrlist= data;
                $scope.searchText = val;
        ...
        $scope.savehrApplication = function () {
            ...
            $http.post($scope.hiposServerURL + '/saveHrApplication', angular.toJson(saveHrDetails, "Create")).then(function (response, status, headers, config) {
                var data = response.data;
                if (data == "") {
        ...
        $scope.saveKivDetails = function () {
            ...
            $http.post($scope.hiposServerURL + '/saveKIVDetails', angular.toJson(saveKivDetails, "Create")).then(function (response, status, headers, config) {
                var data = response.data;
                if (data == "") {
                    Notification.error({message: 'Already exists', positionX: 'center', delay: 2000});
                }
        ...
        $scope.savesecondInterviewDetails = function () {
            ...
            $http.post($scope.hiposServerURL + '/savesecondInterviewDetails', angular.toJson(saveDetails, "Create")).then(function (response, status, headers, config) {
                var data = response.data;
                if (data == "") {
                    Notification.error({message: 'Already exists', positionX: 'center', delay: 2000});
                }
        ...
        $scope.saveInterviewDetails = function () {
            if($scope.interviewtime==null||$scope.interviewtime==undefined){
                ...
                $http.post($scope.hiposServerURL + '/saveInterviewDetails', angular.toJson(saveKivDetails, "Create")).then(function (response, status, headers, config) {
                    var data = response.data;
                    if (data == "") {
                        Notification.error({message: 'Already exists', positionX: 'center', delay: 2000});
                    }
            ...
            if ($scope.interviewerSchedStatus === '' || $scope.interviewerSchedStatus == null || angular.isUndefined($scope.interviewerSchedStatus)) {
                ...
                $http.post($scope.hiposServerURL + '/saveInterviewSchedDetails', angular.toJson(saveKivDetails, "Create")).then(function (response, status, headers, config) {
                    var data = response.data;
                    if (data == "") {
                        Notification.error({message: 'Already exists', positionX: 'center', delay: 2000});
                    }
        ...
        $scope.getEmployeeList = function () {
            $http.post($scope.hiposServerURL + '/getEmployeeList').then(function (response) {
                var data = response.data;
        ...
        $scope.access = function(data){
            ...
            $window.location.href="/anthyesti#!/teacherobservation";
        ...
        $scope.deleteAdmission = function (data) {
            bootbox.confirm({
                ...
                callback: function (result) {
                    if (result == true) {
                        $http.post($scope.hiposServerURL + '/deleteAdmission?id='+ data.hrId).then(function (response) {
                            var data = response.data;
                            $scope.getHrList();
                            if (data == "") {
                                Notification.error({
        ...
        $scope.addKIVModal = function (id) {
            $scope.kivid = id;
            $http.post($scope.hiposServerURL + '/addKIVModal?hrId='+ id).then(function (response) {
                var data = response.data;
        ...
        $scope.addInterviewModal = function (id) {
            ...
            $http.post($scope.hiposServerURL + '/addInterviewModal?hrId=' + id).then(function (response) {
                var data = response.data;
        ...
        $scope.add2InterviewModal = function (id) {
            ...
            $http.post($scope.hiposServerURL + '/getSecondInterviewDetails?hrId=' + id).then(function (response) {
                var data = response.data;
        ...
        $scope.offerLetter = function (id) {
            $http.post($scope.hiposServerURL + '/hrDetailsModal?hrId=' + id).then(function (response) {
                var data = response.data;
                if (data.reportingDate != null) {
        ...
        $scope.acceptanceLetter = function (id) {
            $http.post($scope.hiposServerURL + '/acceptanceDetails?hrId=' + id).then(function (response) {
                var data = response.data;
                $scope.employeeDetails=data;
        ...
        $scope.saveAcceptance = function(){
            ...
            $http.post($scope.hiposServerURL + '/saveAcceptance', angular.toJson(saveAcceptance)).then(function (response) {
                var data = response.data;
                if (data === "") {
                    Notification.error({
